...
SECRET_KEY = 'django-insecure-byls^^m$7z$b8)n1$by%lrl!8-v&e^=!z8p@3(9mjqyq9(djdv'
...
MIDDLEWARE = [
    ...
    'allauth.account.middleware.AccountMiddleware', #here we have to add this middleware
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'external_html.urls'
...
WSGI_APPLICATION = 'external_html.wsgi.application'
